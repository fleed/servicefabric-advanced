namespace WebApplication
{
    ...
    using WebApplication.HttpPipeline;

    using StatelessService = Microsoft.ServiceFabric.Services.Runtime.StatelessService;

    public class Program
    {
        private const string ServiceTypeName = "WebApplicationType";

        private const string EndpointName = "WebApplicationServiceEndpoint";
